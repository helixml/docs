...
This example shows the Helix Chat Widget integrated with the <a href="https://docs.helix.ml/helix/develop/helix-tools-example/" target="_self">Helix API Tools</a> to provide a seamless experience.
