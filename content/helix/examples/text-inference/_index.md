...
Helix provides text inference using models like Llama and Qwen. This page includes example prompts to help you get started.

## Getting Started

Log in at [app.tryhelix.ai](https://app.tryhelix.ai) and start a new chat session.

![Chat interface](prompts/chat.png)
...
These prompts work well with agents that have relevant knowledge bases attached.
...
Have great prompts to share? Join us on [Discord](https://discord.gg/VJftd844GE)!
